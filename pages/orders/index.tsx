      ...
      <OuterContainer>
        ...
        <SOrderContainer>
          {orders.map((order) => {
            ...
            return (
              <SOrderWrapper key={order._id}>
                <SImageContainer>
                  <SOrderImage
                    src={`${imageBaseurl}/${order.photo}`}
                    srcSet={`${imageBaseurl}/${order.photo}`}
                  />
                </SImageContainer>
                <SOrderContent>
                  <h2>{order.prod_name.toLowerCase()}</h2>
                  <small>
                    {order.count}
                  ...
                  <SOrderPriceContainer>
                    <div>
                      ...
                      <p id="order-cost">₹{order.discount_price}</p>
                    </div>
                    <p>₹{order.discount_price * order.count}</p>
                  </SOrderPriceContainer>
                </SOrderContent>
              </SOrderWrapper>
            );
